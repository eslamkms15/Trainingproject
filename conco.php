            ...
            <div class="card-body">
              <table id="customers">
                <tr class="bg-dark text-white">
                  <td> مجموع ساعات التدريب المسجلة </td>
                  <td> عدد الساعات الموافق عليها من قبل المشرف </td>
				  <td> عدد الساعات الموافق عليها من قبل المدرب </td>
                ...
                ?>
                  <td><?php echo $row['hours']; echo '  ساعات'; ?></td>
                  <td><?php echo $row['hours']; echo '  ساعات';  ?></td>
				  <td><?php echo $row['hours']; echo '  ساعات';  ?></td>
