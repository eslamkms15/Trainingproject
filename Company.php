        ...
        <div class="col">
          <div class="card mt-5">
            <div class="card-header">
              <h2 class="display-6 text-center">الرجاء اختيار الشركة</h2>
            </div>
            <div class="card-body">
              <table id="customers">
                ...
                ?>
                  ...
                  <td><a href="departments.php?ID=<?php echo $row['ID'] ?>&Name=<?php echo $row['Name'] ?>" class="btn btn-primary">عرض الاقسام</a></td>  
